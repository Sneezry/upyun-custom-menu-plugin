...
var UPYUNFrom = function(options) {
  // Default options
  this.options = {
...
UPYUNFrom.prototype.request = function(path, parameter, file, callback) {
...
UPYUNFrom.prototype.upload = function(bucket, relativePath, file, filename, filetype, callback) {
  var scope = this,
      parameter = {},
